...
def calculateEmitterToDetectorSection(angleOfEmitter):
...
while True:
    ...
    for i in range(halfNumberOfEmitters):
        ...
        tempSection = calculateEmitterToDetectorSection(angleOfSideEmitter)
        x1 = tempSection[0]
        y1 = tempSection[1]
        x2 = tempSection[2]
        y2 = tempSection[3]
    ...
    tempSection = calculateEmitterToDetectorSection(currentAngleOfMiddleEmitter)
    mx1 = tempSection[0]
    my1 = tempSection[1]
    mx2 = tempSection[2]
    my2 = tempSection[3]
